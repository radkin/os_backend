...
import co.inajar.oursponsors.services.fec.CommitteeImpl;
...
public class CommitteeServiceTests {
    ...
    @InjectMocks
    private CommitteeImpl committeeManager;


    @Test
    public void CommitteeManager_CreateSenatorCommittee_ReturnsSenatorCommittee() {
        ...
        Committee savedCommittee = committeeManager.createCommittee(senator, fecCommitteeId);
    ...
    public void CommitteeManager_CreateCongressCommittee_ReturnsCongressCommittee() {
        ...
        when(committeeRepo.save(Mockito.any(Committee.class))).thenReturn(committee);
        Committee savedCommittee = committeeManager.createCommittee(congress, fecCommitteeId);
        Assertions.assertThat(savedCommittee).isNotNull();
        Assertions.assertThat(savedCommittee.getFecCommitteeId()).isEqualTo(fecCommitteeId);
    }
    ...
    @Test void CommitteeManager_GetCommittees_ReturnsListOfCommittees() {
        ...
        Committee savedCommittee1 = committeeManager.createCommittee(congress, fecCommitteeId);

        when(committeeRepo.save(Mockito.any(Committee.class))).thenReturn(committee2);
        Committee savedCommittee2 = committeeManager.createCommittee(congress, fecCommitteeId);
